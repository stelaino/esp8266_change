...
/***********************************************************************************************************************/
#define CFG_HOLDER    0x00FF55A18    /* Change this value to load default configurations */

/*DEFAULT CONFIGURATIONS*/

#define MQTT_HOST            "106.12.132.115" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            61613    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID        "19980132"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
...
#define STA_SSID "CATS"    // your AP/router SSID to config your device networking
#define STA_PASS "snow2019" // your AP/router password
...
#define CFG_LOCATION    0x80    /* Please don't change or if you know what you doing */
